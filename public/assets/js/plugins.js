...
window.SEMICOLON_tabsResponsive = function( $tabsEl ){
	...
	$tabsEl.each( function(){
		...
		elementNav.children('li').each( function(){
			...
			elementContent.find(navElTarget).before('<div class="accordion-footer d-none"><div class="accordion-icon"><i class="accordion-closed icon-ok-circle"></i><i class="accordion-open icon-remove-circle"></i></div><div class="accordion-title">'+navElContent+'</div></div>');
		});
	});
};
...
window.SEMICOLON_tabsResponsiveResizeInit = function( $tabsEl ){
	...
	$tabsEl.each( function(){
		...
		if( $body.hasClass('device-sm') || $body.hasClass('device-xs') ) {
			...
			element.find('.accordion-footer').removeClass('d-none');
			...
			element.find('.accordion-footer').addClass('d-none');
