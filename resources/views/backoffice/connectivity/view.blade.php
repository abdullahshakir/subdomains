...
<section id="content">
        <div class="row">
            ...
            <div class="col-6 text-end">
                <a href="{{url('domains/'.$domainId.'/connectivities/create')}}" class="text-decoration-none text-white btn-sm btn btn-secondary">Create</a>
            </div>
        </div>            
                ...
                @forelse($data as $key => $item)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{URL::to('domains/'.$domainId.'/connectivities/'.$key.'/edit')}}">
