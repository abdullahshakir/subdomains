    ...
    <section id="content">
        <div class="row">
            ...
            <div class="col-6 text-end">
                <a href="{{url('domains/'.$domainId.'/features')}}" class="text-decoration-none text-white btn-sm btn btn-secondary">Back</a>
            </div>
        </div>
        <div class="form-widget">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="row" action="{{url('domains/'.$domainId.'/features/'.$id['feature'])}}"
