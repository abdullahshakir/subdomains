        ...
        <div class="container">
            ...
            <div class="row col-mb-50">
                ...
                <div class="col-lg-4 text-center text-lg-start">
                    <img data-animate="fadeInLeftBig" src="assets/images/services/iphone.png" alt="iPhone">
                </div>
                        ...
                        <div class="feature-box fbox-plain fbox-sm fbox-dark">
                            ...
                            <div class="fbox-content">
                                ...
                                <p>Powerful Layout with Responsive functionality that can be adapted to any screen
                                    size. Resize browser to view the changes.</p>
                            </div>
                        </div>
                    ...
                    <div class="w-100 mb-5">
                        ...
                        <div class="feature-box fbox-plain fbox-sm fbox-dark">
                            ...
                            <div class="fbox-content">
                                ...
                                <p>Change the Color Scheme of the Theme in a flash just by changing the 6-digit HEX
                                    code provided in the colors.php file.</p>
                            </div>
                        </div>
                    ...
                    <div class="w-100">
                        ...
                        <div class="feature-box fbox-plain fbox-sm fbox-dark">
                            ...
                            <div class="fbox-content">
                                ...
                                <p>Use any Font you like from Google Web Fonts, Typekit or other Web Fonts. They
                                    will blend in perfectly.</p>
                            </div>
                        </div>
                    </div>
                </div>
