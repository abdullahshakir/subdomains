<section id="content">
        ...
        <div class="container clearfix mb-6">
            ...
            <div class="row align-items-stretch col-mb-50 mb-0">
                <div class="col-lg-6">
                    <div class="form-widget">
                        ...
                        <form class="mb-0" action="<?php echo e(url('domains/'.'1'.'/contact')); ?>" method="post"
            ...
            <div class="row col-mb-50">
                <?php $__empty_1 = true; $__currentLoopData = $connectivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-sm-6 col-lg-3">
                    <div class="feature-box fbox-center fbox-bg fbox-plain">
                        ...
                        <div class="fbox-content">
                            <h3><?php echo e($item['title']); ?><span class="subtitle"><?php echo e($item['description']); ?></span></h3>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\OPS-Project\subdomains\resources\views/pages/contact-us.blade.php ENDPATH**/ ?>