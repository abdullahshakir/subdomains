    ...
    <section id="content">
        <div class="row">
            ...
            <div class="col-6 text-end">
                <a href="<?php echo e(url('domains/'.$domainId.'/features')); ?>" class="text-decoration-none text-white btn-sm btn btn-secondary">Back</a>
            </div>
        </div>
        <div class="form-widget">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="row" action="<?php echo e(url('domains/'.$domainId.'/features/'.$id['feature'])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OPS-Project\subdomains\resources\views/backoffice/feature/update.blade.php ENDPATH**/ ?>