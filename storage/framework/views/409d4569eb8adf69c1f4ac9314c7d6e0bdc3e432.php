    ...
    <section id="content">
        <div class="row">
            ...
            <div class="col-6 text-end">
                <a href="<?php echo e(url('domains/'.$domainId.'/ratings')); ?>"
        ...
        <div class="form-widget">
            ...
            <div class="row">
                <form action="<?php echo e(url('domains/'.$domainId.'/ratings')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OPS-Project\subdomains\resources\views/backoffice/rating/create.blade.php ENDPATH**/ ?>